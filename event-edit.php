...
<?php echo "<p><a href=\"event-delete.php?eventID={$eventID}\" class=\"button-viewdelete\">Delete</a></p>"; ?>

<h1 class="center">Edit: <?php echo $eventName; ?></h1><br>

<div id="page">

<!-- Form Start -->
<form name="form1" method="post" action="editEventRecord.php">
